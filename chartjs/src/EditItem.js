        ...
        <Controller
          ...
          render={({ field: {onChange, ref} }) => (
            ...
            <Select
              ...
              defaultValue={{ label: selectedItemforEdit.title, value: selectProjectsID(selectedItemforEdit, projects), color:selectedItemforEdit.bgColor }}
            />
          )} />
      </div>
      {errors.title && (
        ...
        <Controller
          ...
          rules={{ required: true }}
          render={({ field }) => (
            <AntdInput type="text" value="xxx" placeholder="New Description" {...field} />
          )}
        />
        {errors.description && (
